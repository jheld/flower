            ...
            try:
                ...
                if search:
                    ...
                    if search_terms:
                        ...
                        if 'runtime__gte' in search_terms:
                            es_s = es_s.query(Range(runtime=dict(gte=search_terms["runtime__gte"])))
                        if 'runtime__lte' in search_terms:
                            es_s = es_s.query(Range(runtime=dict(lte=search_terms["runtime__lte"])))
