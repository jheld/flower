...
from .options import options as other_options
...
class EventsState(State):
    ...
    def event(self, event):
        ...
        if not self.counter[worker_name] and other_options.elasticsearch_dashboard is True:
            from elasticsearch import Elasticsearch
            ELASTICSEARCH_URL = other_options.elasticsearch_url
